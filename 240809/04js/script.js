...
const muiutePointer = document.querySelector("#minute");
...
const clock = () => {
  ...
  let minutAngle = minute * 6;
  let minutAngleValue = `rotate(${minutAngle}deg)`;
  ...
  muiutePointer.style.transform = minutAngleValue;
