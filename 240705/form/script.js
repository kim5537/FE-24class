...
tokenConfirmButton.addEventListener("click", function (e) {
  ...
  signupButton.style =
    "background-color:#fff; border: 1px solid #0068ff; cursor:pointer";
...
signupButton.addEventListener("click", (e) => {
  ...
  //단락회로 평가 =>true /false=>기본값 true\\false
  ...
  if (
    ...
    document.querySelector("#error_lacation").innerText = "지역을 선택해주세요";
    isValid = false;
  } else {
